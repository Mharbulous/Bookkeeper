    ...
    <div class="max-w-6xl mx-auto">
      ...
      <v-card class="mb-4">
        <v-card-title class="d-flex align-center">
          ...
          {{ title }}
          <v-spacer />
          <v-chip color="primary" size="small" variant="outlined"> DEV ONLY </v-chip>
        </v-card-title>
      ...
      <v-card v-if="showPerformanceNotes" class="mt-4">
        ...
        <v-card-text>
          <v-alert color="warning" variant="tonal" class="mb-3">
            <strong>Development Mode:</strong> Performance measurements in development mode include
            Vue DevTools overhead and hot-reload monitoring. Production builds will show improved
            performance.
          </v-alert>
